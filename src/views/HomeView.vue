      ...
      <div class="flex flex-row flex-wrap">
          ...
          <Card style="width: 25.5rem; overflow: hidden" class="m-4 mt-12">
            ...
            <template #content>
              <p class="m-0 text-justify text-lg">
                El Consultorio Jurídico Gratuito es parte de la Facultad de Jurisprudencia de la PUCE, encargada de la formación práctica y humanística de sus estudiantes a través de la atención integral jurídica y psicosocial en proyección y promoción de derechos, enfocados a grupos de atención prioritaria y en situación de vulnerabilidad, para incidir en procesos de cambio en la sociedad a nivel local con personal calificado y comprometido con el ejercicio de sus funciones.
              </p>
            </template>
          </Card>
        </div>
        ...
        >
          <Card style="width: 25.5rem; overflow: hidden" class="m-4 mt-12">
            ...
            <template #content>
              <p class="m-0 text-justify text-lg">
                Al 2025 el Consultorio Jurídico Gratuito será el referente a nivel nacional por su modelo de servicio integral en asesorías, patrocinio legal y acompañamiento a grupos de atención prioritaria y personas en situación de vulnerabilidad y por la formación de los estudiantes de varias carreras de la PUCE, aplicando sus conocimientos de forma humanitaria y ética, a través del contacto con casos reales, para la transformación personal y social, al servicio de un mundo fraterno, justo y sostenible.
              </p>
            </template>
          </Card>
        </div>
