  ...
  <div class="p-6">
    ...
    <div class="grid grid-cols-2 gap-4 border-b pb-4">
      ...
      <div>
        ...
        <div
          class="input-spacing grid grid-cols-1 gap-4 mx-auto"
        ...
        >
          ...
          <div
            class="grid grid-cols-2 gap-y-15 gap-x-15 mx-auto"
            style="max-width: 400px"
          >
            <FloatLabel variant="on" class="w-full">
              <InputText
    ...
    <div class="grid grid-cols-2 gap-4 border-b py-4 mb-3">
      ...
      <div>
        <h3 class="text-2xl font-semibold ml-25 mb-18">
          Contacto de Referencia
        </h3>
        <div
          class="input-spacing grid grid-cols-1 gap-4 mx-auto"
                  ...
                  >
                    <div class="flex flex-col gap-8 pt-4">
                      <Message
                        ...
                        :key="message"
                        :class="{
                          'mb-8': !files.length && !uploadedFiles.length,
                        }"
                        severity="error"
                      >
                        {{ message }}
