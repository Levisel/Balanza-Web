    ...
    <div class="case-assignment-container">
      <div class="card">
        <div class="header-section">
          <h1 class="text-2xl font-bold mb-4">Asignación de Casos</h1>
          <button 
            @click="assignAllCases" 
            class="p-button p-button-success"
            :disabled="processing"
          >
            <i class="pi pi-check-circle mr-2"></i>
            Asignar Todos los Casos
          </button>
        </div>
        ...
        <div class="cases-table">
          <div class="table-header">
            ...
            <div class="column-header" style="width: 20%">Asignado a</div>
